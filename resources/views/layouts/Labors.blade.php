...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        @endif
        <div class="row">
            <a href="{{ url('createLabor') }}" class="card-link btn w-10 "
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="align-middle text-center text-sm">Team ID</th>
                                    <th class="align-middle text-center text-sm">Team Name</th>
                                    <th class="align-middle text-center text-sm">Team Description</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($Labor as $Labor)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a href="{{ url('deleteLabor/id/' . $Labor->Labor_id) }}"
