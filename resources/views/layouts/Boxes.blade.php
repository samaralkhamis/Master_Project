                ...
                <tbody> 
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      <img src="{{$product->productImg}}" width="165px" >
                    </td>
                    <td>
                      <p class="align-middle text-center text-sm">{{$product->productName}} </p>
                    </td>
                    
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm bg-gradient-success">{{$product->productPrice}}</span>
                    </td>                  
                    <td class="align-middle text-center text-sm">
